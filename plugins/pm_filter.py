...
async def filter_qualities_cb_handler(client: Client, query: CallbackQuery):
   ...
   # if baal:
    #    search = search.replace(lang, "")
    sea = ""
    quality_search = ["360", "360p", "360P", "480", "480p", "480P", "720", "720p", "720P", "1080", "1080p", "1080P", "1440", " 1440p", "1440P", "2160", "2160p", "2160P"]
    for x in range (len(quality_search)):
        if quality_search[x] in search:
            sea = quality_search[x]
            break
    if sea:
        search = search.replace(sea, "")
...
files, offset, total_results = await get_search_results(chat_id, search, offset=0, filter=True)
  ...
  #  search1 = f"{search1} {qual1}"
    ...
    qual2 = "360p" if qual == "360P" else "480p" if qual == "480P" else "720p" if qual == "720P" else "1080p" if qual == "1080P" else "1440p" if qual == "1440P" else "2160p" if qual == "2160P" 
